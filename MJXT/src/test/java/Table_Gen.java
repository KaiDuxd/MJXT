...
public class Table_Gen {
    ...
    static String condition = "";//"_4"
    static String not_meet = "f_";
    static int key_colnum = 5;
    ...
    public static int write_all_matched(BufferedWriter buffWriter, int th, int type, int counter) throws IOException {
        int share_num = 1;//the number of the identical record
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < 10; i++) {
                counter = write_all_matched(buffWriter, i, (i + 1) * 1000, counter);
            }
            for (int i = 0; i < 10; i++) {
                counter =  write_partly_matched(buffWriter, i + 10, 1000, (i + 1) * 100, counter);
            }
